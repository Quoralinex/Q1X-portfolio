      ...
      <div id="portfolio">
        <ProjectSummary
          ...
          model={{
            ...
            image: {
              src: portfolioAsset('ej-header-logo-1024x256.svg'),
              srcSet: `${portfolioAsset('ej-header-logo-1024x256.svg')} 1024w, ${portfolioAsset('ej-header-logo-1024x256.svg')} 2048w`,
              placeholder: portfolioAsset('ej-header-logo-1024x256.svg'),
              width: 1024,
              height: 256,
            },
          }}
        ...
        <ProjectSummary
          ...
          model={{
            ...
            image: {
              src: portfolioAsset('hardline-sentinel-x-helmet.svg'),
              srcSet: `${portfolioAsset('hardline-sentinel-x-helmet.svg')} 1400w, ${portfolioAsset('hardline-sentinel-x-helmet.svg')} 2400w`,
              placeholder: portfolioAsset('hardline-sentinel-x-helmet.svg'),
              width: 1600,
              height: 1600,
            },
            badge: {
              src: portfolioAsset('hardline-logo.svg'),
              alt: 'Hardline logo',
            },
          }}
        />
        <ProjectSummary
          ...
          model={{
            ...
            primary: {
              src: portfolioAsset('aquacore-underwater-turbines.svg'),
              srcSet: `${portfolioAsset('aquacore-underwater-turbines.svg')} 1600w, ${portfolioAsset('aquacore-underwater-turbines.svg')} 2400w`,
              placeholder: portfolioAsset('aquacore-underwater-turbines.svg'),
              width: 2000,
              height: 1125,
            ...
            gallery: [
              {
                src: portfolioAsset('aquacore-logo-molecule.svg'),
                srcSet: `${portfolioAsset('aquacore-logo-molecule.svg')} 800w, ${portfolioAsset('aquacore-logo-molecule.svg')} 1600w`,
                placeholder: portfolioAsset('aquacore-logo-molecule.svg'),
                width: 1200,
                height: 1200,
                alt: 'AquaCore molecule brand lockup',
              },
              {
                src: portfolioAsset('aquacore-quantum-water-cell.svg'),
                srcSet: `${portfolioAsset('aquacore-quantum-water-cell.svg')} 800w, ${portfolioAsset('aquacore-quantum-water-cell.svg')} 1600w`,
                placeholder: portfolioAsset('aquacore-quantum-water-cell.svg'),
                width: 1200,
                height: 1200,
                alt: 'Diagram of a quantum water memory cell with encapsulated water layer',
              },
              {
                src: portfolioAsset('aquacore-water-battery-chart.svg'),
                srcSet: `${portfolioAsset('aquacore-water-battery-chart.svg')} 800w, ${portfolioAsset('aquacore-water-battery-chart.svg')} 1600w`,
                placeholder: portfolioAsset('aquacore-water-battery-chart.svg'),
                width: 1200,
                height: 1200,
                alt: 'Comparison chart of water-based battery versus lithium-ion and solid-state batteries',
              },
              {
                src: portfolioAsset('aquacore-logo-droplet.svg'),
                srcSet: `${portfolioAsset('aquacore-logo-droplet.svg')} 800w, ${portfolioAsset('aquacore-logo-droplet.svg')} 1600w`,
                placeholder: portfolioAsset('aquacore-logo-droplet.svg'),
                width: 1200,
                height: 1200,
        ...
        <ProjectSummary
          ...
          model={{
            ...
            gallery: [
              {
                src: portfolioAsset('document_cover_logo_lockup.svg'),
                srcSet: `${portfolioAsset('document_cover_logo_lockup.svg')} 1200w, ${portfolioAsset('document_cover_logo_lockup.svg')} 1800w`,
                placeholder: portfolioAsset('document_cover_logo_lockup.svg'),
                width: 1600,
                height: 900,
